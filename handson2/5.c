...
int main()
{
    ...
    if(value == -1)
        perror("\nError while getting _SC_ARG_MAX!");
    else 
    ...
    if(value == -1)
        ...
        perror("\nError while getting _SC_CHILD_MAX!");
    else 
    ...
    if(value == -1)
        perror("\nError while getting _SC_CLK_TCK!");
    else 
    ...
    if(value == -1)
        perror("\nError while getting _SC_OPEN_MAX!");
    else 
    ...
    if(value == -1)
        perror("\nError while getting _SC_PAGESIZE!");
    else 
    ...
    if(value == -1)
        perror("\nError while getting _SC_PHYS_PAGES!");
    else 
    ...
    if(value == -1)
        perror("\nError while getting _SC_AVPHYS_PAGES!");
    else 
